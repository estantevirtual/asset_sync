...
describe AssetSync::Storage do
  ...
  describe '#upload_files' do
    ...
    it 'should correctly set expire date' do
      local_files = ['file1.jpg', 'file1-1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef.jpg']
      local_files += ['dir1/dir2/file2.jpg', 'dir1/dir2/file2-1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef.jpg']
      remote_files = []
      storage = AssetSync::Storage.new(@config)
      allow(storage).to receive(:local_files).and_return(local_files)
      allow(storage).to receive(:get_remote_files).and_return(remote_files)
